...
export const saveComic = async (comic: Comic): Promise<void> => {
...
export const getComics = async (): Promise<Comic[]> => {
  ...
  return new Promise((resolve, reject) => {
    ...
    request.onsuccess = () => {
      ...
      const comics = request.result as Comic[];
      resolve(comics.sort((a, b) => b.timestamp - a.timestamp));
    };
    request.onerror = (e) => reject(e);
  });
};
